...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_LAYER] = LAYOUT_60_ansi(
        ...
        TD(TD_CAPS), MY_MEH_Z, MY_HYPER_X, KC_C, KC_V, KC_B, KC_N, KC_M, LT(SYMBOL_LAYER, KC_COMMA), MY_HYPER_DOT, MT(MOD_RGUI, KC_SLASH), TD(TD_CAPS),
        KC_LCTL, KC_LWIN, KC_LCMD, LT(SHORTCUT_LAYER, KC_SPC), MO(MOUSE_LAYER), LT(RGB_LAYER, KC_APP), _______, KC_RCTL),
