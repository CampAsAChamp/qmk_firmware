...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_LAYER] = LAYOUT_60_ansi(
        ...
        MO(CAPS_LAYER), LCMD_T(KC_A), LOPT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G, KC_H, RSFT_T(KC_J), RCTL_T(KC_K), LOPT_T(KC_L), LCMD_T(KC_SCLN), KC_QUOT, KC_ENT,
        SC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, SC_RSPC,
        KC_LCMD, KC_LOPT, MO(FN_LAYER), KC_SPC, MO(MOUSE_LAYER), QK_LEAD, LT(RGB_LAYER, KC_APP), KC_RCTL),
