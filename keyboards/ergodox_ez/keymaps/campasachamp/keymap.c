...
[BASE] = LAYOUT_ergodox_pretty(
    ...
    KC_LCTL,  _______,  _______,  KC_LALT,  KC_LGUI,                                                                     TT(MOUSE),      TD(TD_UNDO),    TD(TD_COPY),    LGUI(KC_V),     LGUI(KC_GRAVE),
                                                              ...
                                                              KC_SPACE, KC_DELETE, CMD_TAB,       _______, KC_ENTER, KC_BSPC
...
[MOUSE] = LAYOUT_ergodox_pretty(
  ...
  _______, _______, KC_WH_D, KC_MS_U, KC_WH_U, _______, _______,     _______, _______, KC_WH_U, KC_MS_U, KC_WH_D, _______, _______,
